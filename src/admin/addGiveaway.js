...
const AddGiveaway = (props) => {
   ...
   const deleteItem = (key)=>{
    ...
    const addGiveaway = (e)=>{
        ...
        if(giveAwayDetails["sponsor"] == "")
        {
            setDetails({
                ...giveAwayDetails,
                ["error"]:"Please Select sponsor"
            })
                ...
                <Row className="mt-2 mb-2">
                    ...
                    <Col lg={4}>
                        <div className="giveAwayDetails">
                            <div className="item__img">
                                <img src="gugoui.PNG" alt="futsalImg" id="addImage" className='d-block'/> 
                            </div>
                    ...
                    <Row>
                        ...
                        <Col lg={6} className="dateForm">
                            ...
                            <div className="form-group">
                                    <label>Sponsor</label>
                                    <input type="text" className="form-control" name='sponsor' placeholder="Sponsor name" value={giveAwayDetails['sponsor']} onChange={(event)=>{changeHandler(event)}} required/>        
                            </div>
